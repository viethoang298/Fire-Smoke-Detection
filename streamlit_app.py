...
def main():
    ...
    #    st.write("")
    #with col2:
    #    logos = glob('https://github.com/AlimTleuliyev/wildfire-detection/tree/main/dalle-logos/*.png')
    ...
    model = load_model("https://drive.google.com/file/d/1ean1yiBUUNGGyQaCs_Lt0usr-wAM9tqD/view?usp=drive_link")
